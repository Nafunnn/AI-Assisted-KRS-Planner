    ...
    */
    ...
    'providers' => [
        ...
        '9router' => [
            ...
            'url' => env('AI_9ROUTER_URL', 'http://127.0.0.1:20128/v1'),
            'key' => env('AI_9ROUTER_KEY', '9router'),
        ],

        'custom-gateway' => [
            'driver' => 'openai-compatible',
            'url' => env('AI_CUSTOM_GATEWAY_URL'),
            'key' => env('AI_CUSTOM_GATEWAY_KEY', 'custom'),
        ],
